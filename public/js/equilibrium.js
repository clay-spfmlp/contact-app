...
new Vue({
  ...
  data: {
    ...
    equilibriums: [{ number: -7 }, { number: 1 }, { number: 5 }, { number: 2 }, { number: -4 }, { number: 3 }, { number: 0 }],
    equilibriumArray: [],
    equilibriumResult: []
  },
  ...
  methods: {
    addToArray: function addToArray(num) {
    ...
    getEquilibriumIndex: function getEquilibriumIndex() {
      this.equilibriumParse();
      this.$http.post('equilibrium-indexs', { equilibrium: this.equilibriumArray }).then(function (response) {
        this.equilibriumResult = response.data;
      }.bind(this));
      this.equilibriumFocus = true;
    },

    equilibriumParse: function equilibriumParse() {
...
//# sourceMappingURL=equilibrium.js.map
